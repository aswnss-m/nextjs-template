    ...
    h = class e extends Uint8Array {
      ...
      toString(t = "utf8", r = 0, n = this.length) {
        if (((r = r < 0 ? 0 : r), (t = t.toString().toLowerCase()), n <= 0))
          return "";
        if (t === "utf8" || t === "utf-8") return Jl.decode(this.slice(r, n));
        if (t === "base64" || t === "base64url") {
      ...
      if (((t = e.e), (r = e.d.length - 1), (s = t >= r), (o = a.s), s)) {
        if ((r = T < 0 ? -T : T) <= ro) {
          for (
            ...
            r % 2 && ((i = i.times(a)), to(i.d, t)), (r = st(r / 2)), r !== 0;
          )
    ...
    v.toSignificantDigits = v.tosd = function (e, t) {
      ...
      return (
        e === void 0
          ...
          : (xe(e, 1, ot), t === void 0 ? (t = n.rounding) : xe(t, 0, 8)),
        _(new n(r), e, t)
      );
    };
    v.toString =
      ...
      return function (n, i, o, s) {
        ...
        if (((Q = (Q / V + 2) | 0), (f = 0), fe == 1))
          for (T = 0, J = J[0], Q++; (f < je || T) && Q--; f++)
            (F = T * z + (he[f] || 0)), (N[f] = (F / J) | 0), (T = (F % J) | 0);
        else {
          for (
            T = (z / (J[0] + 1)) | 0,
              T > 1 &&
...
function Ae(e) {
  ...
  if (n === "[object Object]") {
    if (e.constructor !== Object && typeof e.constructor == "function") {
      r = new e.constructor();
      for (t in e) e.hasOwnProperty(t) && r[t] !== e[t] && (r[t] = Ae(e[t]));
    } else {
      r = {};
      for (t in e)
        t === "__proto__"
    ...
    ? await t.runInChildSpan(
        {
          name: "db_query",
          kind: er.CLIENT,
          attributes: { "db.query.text": e.sql, "db.system.name": Lp(r) },
        },
        o,
      )
    : o();
  ...
  async interpretNode(t, r) {
    switch (t.type) {
      ...
      case "validate": {
        ...
        return pu(n, t.args.rules, t.args), { value: n, lastInsertId: i };
      }
      case "if": {
        ...
        try {
          if (t.transaction && r === "committed")
            if (t.transaction.options.usePhantomQuery)
              await this.#s(im(), t.transaction, () => t.transaction.commit());
            else {
              let i = rm();
...
var wn = class {
  ...
  #u(t, r, n) {
    ...
    if (Ce(n, ve.ParamListScalar) && t.every((o) => ym(o, n)) && t.length > 0) {
      let o = t.map((m) => hm(m)),
...
${n.backtrace}`,
  ...
  async request(t, { interactiveTransaction: r, customDataProxyFetch: n }) {
    ...
    if (zu(t)) s = Ku(t);
      ...
      let { parameterizedQuery: m, placeholderValues: f } = Du(t, this.#o),
        T = JSON.stringify(m);
      a = f;
  ...
  async requestBatch(t, { transaction: r, customDataProxyFetch: n }) {
    ...
    if (T) A = this.#f(t, a, f);
      ...
      let { parameterizedBatch: S, placeholderValues: N } = Mu(s, this.#o),
        R = JSON.stringify(S);
      C = N;
...
`,
          ...
          for (let f of s.log) {
            ...
            T &&
              this.$on(T, (A) => {
                Vt.log(`${Vt.tags[T] ?? ""}`, A.message || A.query);
              });
          }
      } catch (s) {
...
function Nl(e) {
  return new Proxy(e, {
    get(t, r) {
      ...
      if (!Qm.has(r)) throw new TypeError(`Invalid enum value: ${String(r)}`);
    },
  });
}
u();
