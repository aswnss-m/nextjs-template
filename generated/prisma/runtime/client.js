...
var Pn = Symbol();
function Tt(e) {
  let t = [rp(e), np(e), _(Pn, () => e), _("$parent", () => e._appliedParent)],
...
function X(e) {
  ...
  if (n === "[object Object]") {
    if (e.constructor !== Object && typeof e.constructor == "function") {
      r = new e.constructor();
      for (t in e) e.hasOwnProperty(t) && r[t] !== e[t] && (r[t] = X(e[t]));
    } else {
      r = {};
      for (t in e)
        t === "__proto__"
    ...
    ? await t.runInChildSpan(
        {
          name: "db_query",
          kind: Ct.CLIENT,
          attributes: { "db.query.text": e.sql, "db.system.name": Tp(r) },
        },
        o,
      )
    : o();
        ...
        try {
          if (t.transaction && r === "committed")
            if (t.transaction.options.usePhantomQuery)
              await this.#s(Hd(), t.transaction, () => t.transaction.commit());
            else {
              let i = Qd();
...
var Vr = class {
  ...
  #l(t, r, n) {
    ...
    if (re(n, te.ParamListScalar) && t.every((o) => im(o, n)) && t.length > 0) {
      let o = t.map((l) => om(l)),
...
${n.backtrace}`,
  ...
  async request(t, { interactiveTransaction: r, customDataProxyFetch: n }) {
    ...
    if (ul(t)) s = cl(t);
      ...
      let { parameterizedQuery: l, placeholderValues: u } = Ga(t, this.#o),
        c = JSON.stringify(l);
      a = u;
  ...
  async requestBatch(t, { transaction: r, customDataProxyFetch: n }) {
    ...
    if (c) p = this.#f(t, a, u);
      ...
      let { parameterizedBatch: f, placeholderValues: h } = za(s, this.#o),
        x = JSON.stringify(f);
      d = h;
